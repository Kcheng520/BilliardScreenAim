...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val switchSimpleMode = findViewById<Switch>(R.id.switchSimpleMode)
        switchSimpleMode.isChecked = AppSettings.isSimpleMode(this)
        switchSimpleMode.setOnCheckedChangeListener { _, isChecked ->
            AppSettings.setSimpleMode(this, isChecked)
        }
